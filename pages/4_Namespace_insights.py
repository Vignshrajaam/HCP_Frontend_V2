...
with tab1:
    ...
    st.markdown(
        ...
        <div style="background:#f8f9fa; border-radius:12px; padding:8px 10px;
            ...
            <div style="font-size:14px; font-weight:600; margin-bottom:4px;">Severity scale</div>
            <div style="display:flex; gap:20px; font-size:13px;">
                <span style="color:#c92a2a">🔴 CRITICAL (≥70)</span>
                <span style="color:#e8590c">🟠 HIGH (≥40)</span>
                <span style="color:#e67700">🟡 MEDIUM (≥20)</span>
    ...
    sorted_risk = sorted(risk_report, key=lambda x: sev_order.get(x.get("severity", "LOW"), 9))
